...
export const SPECIALIZED_SHAPE: Readonly<Record<string, ResourceShape>> = {
  ...
  ActivityDefinition: {
    fields: {
      ...
      ...authored,
      subtitle: primitive(),
      subject: choice(['CodeableConcept', 'Reference']),
      usage: primitive(),
      kind: primitive(),
      profile: primitive(),
      code: concept(),
      ...
      timing: choice(['Timing', 'dateTime', 'Age', 'Period', 'Range', 'Duration']),
      location: reference(),
      product: choice(['Reference', 'CodeableConcept']),
      quantity: quantity(),
  ...
  EvidenceVariable: {
    fields: {
      ...
      characteristic: group({
        ...
        exclude: primitive(),
        participantEffective: choice(['dateTime', 'Period', 'Duration', 'Timing']),
  ...
  ResearchElementDefinition: {
    fields: {
      ...
      characteristic: group({
        definition: choice(['CodeableConcept', 'canonical', 'Expression', 'DataRequirement']),
        exclude: primitive(),
